...
const ENTRIES: &[(&str, &str, &str)] = &[
    ...
    ("status.core_state_unknown", "内核状态未知", "Core status unknown"),
    ("status.mode_unknown", "模式未知", "Mode unknown"),
    ("status.connections_waiting", "连接等待中", "Waiting for connections…"),
    ...
    ("profiles.policy.failures", "连续失败", "consecutive failures"),
    ...
    ("settings.app.update.download", "下载并更新", "Download & Update"),
    ...
    ("settings.system.helper.install", "安装/修复", "Install/Repair"),
    ("settings.system.helper.uninstall", "卸载", "Uninstall"),
    ("settings.helper.not_installed", "未安装", "Not installed"),
    ("settings.system.diagnostics", "诊断导出", "Diagnostics Export"),
    (
        "settings.system.diagnostics.export",
        "导出脱敏诊断",
        "Export Redacted Diagnostics",
    ),
    ("settings.system.settings_export", "设置导出", "Settings Export"),
    (
    ...
    ("settings.system.settings_import", "设置导入", "Settings Import"),
    (
    ...
    ("settings.backup.passphrase", "备份口令", "Backup Passphrase"),
    (
    ...
    ("dialog.import.interval", "更新间隔（秒）", "Update Interval (seconds)"),
    (
    ...
    ("dialog.import.local", "导入本地配置", "Import Local Profile"),
    ("dialog.import.remote", "导入远程配置", "Import Remote Profile"),
    ...
    ("dialog.import_settings.title", "导入设置", "Import Settings"),
    (
        "dialog.import_settings.no_changes",
        "与当前设置一致，导入后没有字段变化。",
        "Identical to current settings; importing changes nothing.",
    ),
    ("dialog.import_settings.field_diff", "字段差异", "Field Differences"),
    ...
    ("sheet.yaml.loading", "正在加载配置 YAML…", "Loading profile YAML…"),
    ...
    ("sheet.merge.loading", "正在加载 Merge 配置…", "Loading merge config…"),
    (
        "sheet.merge.load_failed",
        "无法加载 Merge 配置",
        "Failed to load merge config",
    ),
    ("sheet.merge.title", "全局 Merge 配置", "Global Merge Config"),
    (
        "sheet.merge.desc",
    ...
    // ---- Toast / OS 通知 ----
    ("notify.profile_done", "配置操作已完成", "Profile operation completed"),
    (
        "notify.diagnostics_exported",
        "脱敏诊断已导出",
        "Redacted diagnostics exported",
    ),
    ("hint.invalid_input", "请检查输入后重试", "Check your input and try again"),
    (
        "hint.not_found",
        "目标可能已被移除，请刷新后重试",
    ...
    ("toast.merge_saved", "Merge 配置已保存", "Merge config saved"),
    ("toast.remote_updated", "远程配置已更新", "Remote profile updated"),
    ("toast.policy_saved", "更新策略已保存", "Update policy saved"),
    ("toast.profile_deleted", "配置已删除", "Profile deleted"),
    ("toast.diagnostics_exported", "诊断已导出", "Diagnostics exported"),
    ("toast.settings_exported", "设置已导出", "Settings exported"),
    ("toast.settings_imported", "设置已导入", "Settings imported"),
    ("toast.settings_reset", "已恢复默认设置", "Settings reset to defaults"),
    ("toast.backup_exported", "加密备份已导出", "Encrypted backup exported"),
    ("toast.backup_restored", "备份已恢复", "Backup restored"),
    ("toast.mihomo_updated", "Mihomo 内核已更新", "Mihomo core updated"),
    (
        "toast.app_updated",
        "应用更新已就绪，重启后生效",
        "Update ready; takes effect after restart",
    ),
    ("toast.app_restarting", "正在重启 Verge…", "Restarting Verge…"),
    ("toast.provider_updated", "Provider 已更新", "Provider updated"),
];
