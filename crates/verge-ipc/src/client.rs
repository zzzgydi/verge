...
use verge_domain::RealtimeEvent;
use verge_ui::UiRequestEnvelope;
...
pub enum ClientEvent {
    ...
    Response(verge_ui::UiResponseEnvelope),
...
mod tests {
    ...
    use crate::server::{IpcServer, IpcServerEvent};
    ...
    fn requests_flow_to_daemon_side() {
        ...
        let request = UiRequestEnvelope {
            ...
            operation_index: 0,
            operation_len: 1,
            context: verge_domain::CommandContext {
                actor: verge_domain::CommandActor::UserInterface,
                approval: None,
            },
            request: verge_ui::UiRequest::Runtime(verge_domain::RuntimeCommand::GetMode),
        };
