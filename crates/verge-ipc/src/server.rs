...
use verge_domain::{RealtimeEvent, RealtimeTopic};
...
mod tests {
    ...
    use verge_domain::{ConnectionSnapshot, TrafficEvent};
    use verge_ui::{UiResponse, UiResponseEnvelope};
    ...
    fn realtime_broadcast_filters_by_subscription() {
        ...
        let logs = RealtimeEvent::Log(verge_domain::LogEvent {
            level: "info".into(),
            payload: "x".into(),
        });
        server
